...
public class ScrollingTabContainerView extends NineHorizontalScrollView
	...
	public static class TabView extends LinearLayout {
		...
		public void init(final ScrollingTabContainerView parent, final ActionBar.Tab tab, final boolean forList) {
			mParent = parent;
			mTab = tab;
		...
		public void update() {
			...
			if (custom != null) {
				...
				if (text != null) {
					if (mTextView == null) {
						final CapitalizingTextView textView = new CapitalizingTextView(getContext(), null,
	...
	protected class VisibilityAnimListener implements Animator.AnimatorListener {
		...
		public VisibilityAnimListener withFinalVisibility(final int visibility) {
	...
	public ScrollingTabContainerView(final Context context) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(null, R.styleable.SherlockActionBar,
	...
	public ScrollingTabContainerView(final Context context, final AttributeSet attrs) {
		super(context, attrs);
		setHorizontalScrollBarEnabled(false);

		final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SherlockActionBar,
				R.attr.actionBarStyle, 0);
		setContentHeight(a.getLayoutDimension(R.styleable.SherlockActionBar_height, 0));
		a.recycle();
	...
	public ScrollingTabContainerView(final Context context, final AttributeSet attrs, final int defStyle) {
		super(context, attrs, defStyle);
		setHorizontalScrollBarEnabled(false);

		final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SherlockActionBar,
				R.attr.actionBarStyle, defStyle);
		setContentHeight(a.getLayoutDimension(R.styleable.SherlockActionBar_height, 0));
		a.recycle();
	...
	public void animateToVisibility(final int visibility) {
		...
		if (visibility == VISIBLE) {
			...
			final ObjectAnimator anim = ObjectAnimator.ofFloat(this, "alpha", 1);
			...
			final ObjectAnimator anim = ObjectAnimator.ofFloat(this, "alpha", 0);
			anim.setDuration(FADE_DURATION);
			anim.setInterpolator(sAlphaInterpolator);
	...
	private TabView createTabView(final ActionBar.Tab tab, final boolean forAdapter) {
	...
	@Override
	public void onItemSelected(final IcsAdapterView<?> parent, final View view, final int position, final long id) {
		final TabView tabView = (TabView) view;
		tabView.getTab().select();
	}
