 ...
 * </p>
 * <p>
 * <strong>Note:</strong> While the sample snippet demonstrates how to use this provider in the context of a menu item, the use of the provider is not limited to menu items.
 * </p>
 * 
 * @see ActionProvider
 */
public class ShareActionProvider extends ActionProvider {
	...
	private class ShareMenuItemOnMenuItemClickListener implements OnMenuItemClickListener {
		...
		public boolean onMenuItemClick(final MenuItem item) {
			final ActivityChooserModel dataModel = ActivityChooserModel.get(mContext,
	...
	public View onCreateActionView() {
		...
		final ActivityChooserModel dataModel = ActivityChooserModel.get(mContext, mShareHistoryFileName);
		...
		final Drawable drawable = mContext.getResources().getDrawable(outTypedValue.resourceId);
	...
	public void onPrepareSubMenu(final SubMenu subMenu) {
		...
		// subMenu.add(0, i, i, "I am a title"/* activity.loadLabel(packageManager) */)
		...
		// final SubMenu expandedSubMenu = subMenu.addSubMenu(Menu.NONE, collapsedActivityCount,
	 ...
	 * for all view created by {@link #onCreateActionView()}. Defaults to {@link #DEFAULT_SHARE_HISTORY_FILE_NAME}. Set to <code>null</code> if share history should not be persisted between sessions.
	 * <p>
	 * <strong>Note:</strong> The history file name can be set any time, however only the action views created by {@link #onCreateActionView()} after setting the file name will be backed by the provided file.
	 * <p>
	 * 
